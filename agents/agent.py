...
class Actor:
    ...
    def build_model(self):
        ...
        raw_actions = layers.Dense(units=self.action_size,
                                   ...
                                   bias_initializer=layers.initializers.RandomUniform(minval=-3e-4, maxval=3e-4),
                                   activation='sigmoid',
...
class Critic:
    ...
    def build_model(self):
        ...
        Q_values = layers.Dense(units=1, name='q_values',
                                kernel_initializer=layers.initializers.RandomUniform(minval=-3e-3, maxval=3e-3),
                                bias_initializer=layers.initializers.RandomUniform(minval=-3e-4, maxval=3e-4))(net)
